...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, maim vhai.") {
    api.sendMessage(`I made by master 𝐏𝐫𝐢𝐲𝐚𝐧𝐬𝐡 𝐑𝐚𝐣𝐩𝐮𝐭, also known as maim vhaiu`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is maim vhai's laptop. What is your birthplace?") {
    ...
    return;
            ...
            if(res === "I was created by maim vhai.") {
